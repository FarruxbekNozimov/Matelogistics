...
<template>
	<header class="z-50 w-full bg-white/90 fixed left-0">
		<!-- TOP GRAY HEADER -->
		<HeaderTop />
		<nav class="flex w-full items-center justify-between p-4 px-0">
			<div class="flex items-center justify-center gap-5">
				<button class="lg:hidden text-[#008AFF] ml-3">
			...
			<!-- NAVBAR INTRO BUTTONS-->
			<div class="flex gap-5 lg:justify-end px-2">
				<router-link
					to="/quote"
				...
				<router-link
					to="/quote"
					class="hidden lg:block text-sm border border-blue-500 text-blue-500 p-2 px-4 rounded-2xl hover:bg-blue-500 hover:text-white duration-300 font-bold">
					+1 (929) 592-3003
				</router-link>
			</div>
		</nav>
